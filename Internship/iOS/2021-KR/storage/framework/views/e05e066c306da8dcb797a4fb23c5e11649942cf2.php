    ...
    <div class="form-floating" style="text-align: center; width: 400px; margin-top: 300px">
        <div class="form-group" style="vertical-align: center; height: 500px">
            <div style="text-align: center">
                <label id="mainLabel" class="form-label" style="font-size: 28px"><?php echo e(__('numbers.label')); ?></label><br>
            </div>
            <div class="">
...
<?php /**PATH C:\OpenServer\domains\numbers\resources\views/number.blade.php ENDPATH**/ ?>